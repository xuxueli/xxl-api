...
import com.xxl.api.admin.core.util.PropertiesUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    static {
        String username = PropertiesUtil.getString("xxl.api.login.username");
        String password = PropertiesUtil.getString("xxl.api.login.password");
