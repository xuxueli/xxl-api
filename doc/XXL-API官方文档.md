...
### v1.7.1 Release Notes[2026-06-07]
...
### v1.7.2 Release Notes[ING]
- 1、【ING】支持设置RequestBody类型，支持form、body、raw等类型；
- 2、【ING】支持swagger、postman等格式数据导入；
- 3、【ING】支持API分享；支持设置用户、公网等权限；
- 4、【ING】公共API收录：部署默认安装，同Apihub；
