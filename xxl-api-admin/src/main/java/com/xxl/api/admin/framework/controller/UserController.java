package com.xxl.api.admin.framework.controller;

import com.xxl.api.admin.framework.constant.Consts;
import com.xxl.api.admin.business.model.XxlApiBiz;
import com.xxl.api.admin.framework.model.XxlApiUser;
import com.xxl.api.admin.business.mapper.XxlApiBizMapper;
import com.xxl.api.admin.framework.mapper.XxlApiUserMapper;
import com.xxl.api.admin.framework.util.I18nUtil;
import com.xxl.api.admin.framework.util.StringTool2;
...
public class UserController {
	...
	public String index(Model model) {
		...
		return "framework/user/user.list";
	}
