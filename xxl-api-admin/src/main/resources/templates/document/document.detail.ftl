    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <form class="form-horizontal" id="ducomentForm">
                        ...
                        <div class="chart tab-pane active" id="success_resp" style="position: relative; height: 100%;">
                            <div class="box-body">
                                ...
                                <pre name="successRespExample"
                                     <#if "JSON"==document.successRespType >class="jsonViewPre"</#if> style="width: 100%; height: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin-top: 15px;">${document.successRespExample}</pre>
                            </div>
                        </div>
                        <div class="chart tab-pane" id="fail_resp" style="position: relative; height: 100%;">
                            <div class="box-body">
                                ...
                                <pre name="failRespExample"
                                     <#if "JSON"==document.successRespType >class="jsonViewPre"</#if> style="width: 100%; height: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin-top: 15px;">${document.failRespExample}</pre>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <ul style="display: block;">
                                        <#list fieldList as field>
                                            <li>
                                                ...
                                                {类型：${field.fieldDatatype.name} <#if field.fieldType==1>[]</#if>
                                                ，描述：${field.fieldAbout}}
                ...
                <#--Mock数据-->
                <div class="box box-primary" id="form-container">
                    <div class="box-header">
                    ...
                    <div class="box-body no-padding">
                        <table class="table table-striped">
                            ...
                            <#list mockList as mock>
                                <textarea id="respExample_${mock.id}"
                                          style="display: none;">${mock.respExample}</textarea>
                                <tr>
                                    <td>${mock.respType}</td>
                                    <td>
                                        ...
                                        <a href="javascript:;" class="updateMock" _id="${mock.id}"
                                           ...
                                           onmouseout="this.style.cssText='color:gray;'"><i
                                                    class="fa fa-fw fa-wrench"></i>修改</a>
                                        &nbsp;
                                        ...
                                        <a href="javascript:;" class="fa fa-fw fa-copy" _id="${mock.id}"
                                           style="width: 100px"
                                           onclick="copyToClipboard('${request.contextPath}/mock/run/${mock.uuid}')">
                                            复制链接
                                        </a>
                ...
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        <div class="col-sm-12">
                            响应数据类型(MIME)：
                            <#list ResponseContentType as item>
                                <input type="radio" class="iCheck" name="respType"
                                       value="${item}" >${item}  &nbsp;&nbsp;
                            </#list>
                        </div>
                    </div>
...
<script type="text/javascript">
    var copyToClipboard = function (content) {
        if (!!content) {
            const transfer = $("<input type='text' id='copy_text'>");
            let finalUrl = window.location.origin + content;
            $('#form-container').append(transfer);//form-container是复制按钮的祖先节点
            transfer.val(finalUrl)
            transfer.focus();
            transfer.select();
