            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <#--<button class="btn btn-default btn-xs" onclick="javascript:openTab('${request.contextPath}/group?projectId=${projectId}', '项目接口列表', true)" type="button" >返回接口列表</button>-->
                    ...
                    if (data.code == "200") {
                        ...
                        layer.open({
                            ...
                            content: "新增成功" ,
                                ...
                                // 关闭当前，跳转详情页；
                                let url = base_url + '/document/detailPage?id=' + data.data;
                                openTab(url, "查看接口信息" + url, true)
                            }
                        });
                    } else {
                        layer.open({
